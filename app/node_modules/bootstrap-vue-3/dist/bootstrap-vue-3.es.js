...
const Ve = Jl ? Element.prototype : void 0, Yl = (Ve == null ? void 0 : Ve.matches) || (Ve == null ? void 0 : Ve.msMatchesSelector) || (Ve == null ? void 0 : Ve.webkitMatchesSelector), Oe = (e) => !!(e && e.nodeType === Node.ELEMENT_NODE), Zl = (e) => Oe(e) ? e.getBoundingClientRect() : null, Ql = (e = []) => {
...
}, Te = (e, t) => !e || e(t).filter((a) => a.type !== $l).length < 1, $a = (e, t) => (Oe(t) ? t : mt).querySelector(e) || null, oo = (e, t) => Array.from([(Oe(t) ? t : mt).querySelectorAll(e)]), Nt = (e, t) => t && Oe(e) ? e.getAttribute(t) : null, no = (e) => mt.getElementById(/^#/.test(e) ? e.slice(1) : e) || null, so = (e, t, a) => {
  t && Oe(e) && e.setAttribute(t, a);
}, ro = (e, t) => {
  t && Oe(e) && e.removeAttribute(t);
}, io = (e, t) => _t(e).toLowerCase() === _t(t).toLowerCase(), at = ba ? window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.msRequestAnimationFrame || window.oRequestAnimationFrame || ((e) => setTimeout(e, 16)) : (e) => setTimeout(e, 0), ka = (e, t) => Oe(e) ? Yl.call(e, t) : !1, uo = (Ve == null ? void 0 : Ve.closest) || function(e) {
  let t = this;
  if (!t)
    return null;
  do {
...
), n), []), ze = (e = "") => `__BVID__${Math.random().toString().slice(2, 8)}___BV_${e}__`, pt = (e, t) => e === !0 || e === "true" || e === "" ? "true" : e === "grammar" || e === "spelling" ? e : t === !1 ? "true" : e === !1 || e === "false" ? "false" : void 0, Ct = (e) => !!e && typeof e == "object" && e.constructor === Object, Vt = (e, t, a = !0) => {
  ...
  return Ct(e) && Ct(t) && Object.keys(t).forEach((n) => {
    Ct(t[n]) ? n in e ? l[n] = Vt(e[n], t[n], a) : Object.assign(l, { [n]: t[n] }) : Array.isArray(t[n]) && Array.isArray(e[n]) ? Object.assign(l, {
      [n]: a ? e[n].concat(
...
const wa = Symbol(), Ta = {
  ...
  setup(e, { emit: t }) {
    ...
    return ne(
      ...
      (B) => {
        var C, V;
        B ? (C = v.value) == null || C.show() : (V = v.value) == null || V.hide();
      }
    ), ne(
      () => u.value,
      (B) => {
        var C, V;
        B ? (t("update:modelValue", !!B), (C = v.value) == null || C.show()) : (t("update:modelValue", !!B), (V = v.value) == null || V.hide());
      }
...
const To = {
  ...
  BVisible: So,
  focus: To
}, Vo = { class: "accordion-item" }, Ao = ["id"], xo = ["aria-expanded", "aria-controls"], Io = { class: "accordion-body" }, Fo = /* @__PURE__ */ x({
  ...
  setup(e, { emit: t }) {
    ...
    let f;
    const c = U(null), v = U(), h = i(() => !Te(u.close)), p = i(() => !!a.modelValue || n.value), B = i(() => [
      [`alert-${a.variant}`],
      {
        show: !!a.modelValue,
      ...
      const H = Ue(S, 0);
      return H > 0 ? H : 0;
    }, V = U(C(a.modelValue)), A = i(() => a.modelValue === !0 ? !0 : a.modelValue === !1 || Ue(a.modelValue, 0) < 1 ? !1 : !!a.modelValue), b = () => {
      f !== void 0 && (clearTimeout(f), f = void 0);
    }, k = () => {
      V.value = C(a.modelValue), (A.value || n.value) && !v.value && (v.value = new Pl(c.value));
    }, y = () => {
      typeof a.modelValue == "boolean" ? t("update:modelValue", !1) : t("update:modelValue", 0), t("closed");
    };
    return ne(() => a.modelValue, k), ne(() => n.value, k), ne(V, (S) => {
  ...
  setup(e, { emit: t }) {
    const a = e, l = $e(), n = Ne(Ha, null), u = ["sm", null, "lg"], f = 0.4, c = f * 0.7, v = r(s(a, "badgeLeft")), h = r(s(a, "badgeTop")), p = r(s(a, "button")), B = r(s(a, "disabled")), C = r(s(a, "square")), V = i(() => !Te(l.default)), A = i(() => !Te(l.badge)), b = i(() => !!a.badge || a.badge === "" || A.value), k = i(
...
const _e = /* @__PURE__ */ Se(Do, [["render", Ro]]), Jt = ct(je, ["event", "routerTag"]), jo = x({
  components: { BLink: _e },
  props: {
...
const Mo = /* @__PURE__ */ Se(jo, [["render", qo]]), Yt = ct(je, ["event", "routerTag"]), Go = x({
  components: { BLink: _e },
  props: {
    ...Yt,
    active: { type: [Boolean, String], default: !1 },
...
const Da = /* @__PURE__ */ Se(Go, [["render", Uo]]), Wo = { "aria-label": "breadcrumb" }, Xo = { class: "breadcrumb" }, Ko = /* @__PURE__ */ x({
  __name: "BBreadcrumb",
  props: {
    items: null
  },
  ...
  components: { BLink: _e, BSpinner: gt },
  props: {
    ...je,
    active: { type: [Boolean, String], default: !1 },
    disabled: { type: [Boolean, String], default: !1 },
...
const et = /* @__PURE__ */ Se(Yo, [["render", Zo]]), Qo = /* @__PURE__ */ x({
  __name: "BButtonGroup",
  props: {
  ...
  setup(e, { emit: t }) {
    const a = e, l = '<svg width="%{w}" height="%{h}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 %{w} %{h}" preserveAspectRatio="none"><rect width="100%" height="100%" style="fill:%{f};"></rect></svg>', n = r(s(a, "lazy")), u = r(s(a, "blank")), f = r(s(a, "block")), c = r(s(a, "center")), v = r(s(a, "fluid")), h = r(s(a, "fluidGrow")), p = r(s(a, "left")), B = r(s(a, "start")), C = r(s(a, "right")), V = r(s(a, "end")), A = r(s(a, "thumbnail")), b = i(
      ...
      const z = (D) => D === void 0 ? void 0 : typeof D == "number" ? D : Number.parseInt(D, 10) || void 0, $ = z(a.width), _ = z(a.height);
      if (u.value) {
        if ($ !== void 0 && _ === void 0)
          return { height: $, width: $ };
        if ($ === void 0 && _ !== void 0)
      ...
      () => p.value || B.value ? "float-start" : C.value || V.value ? "float-end" : c.value ? "mx-auto" : void 0
    ), F = i(() => ({
    ...
    })), L = (z, $, _) => `data:image/svg+xml;charset=UTF-8,${encodeURIComponent(
      l.replace("%{w}", String(z)).replace("%{h}", String($)).replace("%{f}", _)
    )}`;
    return (z, $) => (d(), m("img", W({ class: o(F) }, o(H), {
      onLoad: $[0] || ($[0] = (_) => t("load", _))
    }), null, 16));
  }
}), dt = /* @__PURE__ */ x({
  __name: "BCardImg",
  ...
  setup(e) {
    const t = e, a = $e(), l = r(s(t, "overlay")), n = i(() => !Te(a.title)), u = i(() => !Te(a.subtitle)), f = i(() => ({
  ...
  setup(e) {
    const t = e, a = $e(), l = r(s(t, "imgBottom")), n = r(s(t, "imgEnd")), u = r(s(t, "imgLeft")), f = r(s(t, "imgRight")), c = r(s(t, "imgStart")), v = r(s(t, "noBody")), h = i(() => !Te(a.header)), p = i(() => !Te(a.footer)), B = i(() => ({
    ...
    return (k, y) => (d(), P(X(e.tag), {
      ...
      default: O(() => [
        ...
        o(v) ? g(k.$slots, "default", { key: 3 }, () => [
          J(j(e.bodyText), 1)
        ]) : (d(), P(Ga, W({ key: 2 }, o(V), { class: e.bodyClass }), {
          default: O(() => [
            g(k.$slots, "default", {}, () => [
              J(j(e.bodyText), 1)
            ])
  ...
  setup(e, { emit: t }) {
    ...
    return be(v, "slide.bs.carousel", (B) => t("sliding-start", B)), be(v, "slid.bs.carousel", (B) => t("sliding-end", B)), Be(() => {
      ...
      o(f) ? (d(), m("div", sn, [
        (d(!0), m(Z, null, re(p.value, (V, A) => (d(), m("button", {
          key: A,
          type: "button",
          "data-bs-target": `#${o(n)}`,
          "data-bs-slide-to": A,
  ...
  setup(e) {
    const t = e, a = $e(), l = Ne(Xa, {}), n = r(s(t, "active")), u = i(() => !Te(a.default)), f = i(() => ({
...
const Ze = /* @__PURE__ */ Se(Cn, [["render", Sn]]), wn = /* @__PURE__ */ x({
  __name: "BContainer",
  props: {
    gutterX: null,
    gutterY: null,
...
}), Tn = { class: "visually-hidden" }, _n = ["aria-labelledby", "role"], Ka = /* @__PURE__ */ x({
  __name: "BDropdown",
  props: {
    id: null,
    menuClass: null,
  ...
  setup(e, { expose: t, emit: a }) {
    const l = e, n = ye(s(l, "id"), "dropdown"), u = r(s(l, "block")), f = r(s(l, "dark")), c = r(s(l, "dropup")), v = r(s(l, "dropright")), h = r(s(l, "isNav")), p = r(s(l, "dropleft")), B = r(s(l, "right")), C = r(s(l, "split")), V = r(s(l, "noCaret")), A = U(), b = U(), k = U(), y = i(() => ({
      "d-grid": u.value,
      ...
      C.value ? l.splitClass : l.toggleClass,
      {
        ...
        "dropdown-toggle-no-caret": V.value && !C.value,
    ...
    return be(A, "show.bs.dropdown", () => a("show")), be(A, "shown.bs.dropdown", () => a("shown")), be(A, "hide.bs.dropdown", () => a("hide")), be(A, "hidden.bs.dropdown", () => a("hidden")), Be(() => {
      ...
      k.value = new zl(($ = b.value) == null ? void 0 : $.$el, {
        ...
        popperConfig: (_) => {
          ...
          return c.value ? D.placement = B.value ? "top-end" : "top-start" : v.value ? D.placement = "right-start" : p.value ? D.placement = "left-start" : B.value && (D.placement = "bottom-end"), Vt(_, Vt(D, l.popperOpts));
        }
      });
    }), t({
      hide: L
...
}), Vn = { role: "presentation" }, An = /* @__PURE__ */ x({
  __name: "BDropdownDivider",
  props: {
    tag: { default: "hr" }
  },
  setup(e) {
    return (t, a) => (d(), m("li", Vn, [
      (d(), P(X(e.tag), {
...
const On = /* @__PURE__ */ Se(xn, [["render", Pn]]), zn = { role: "presentation" }, Ln = ["id", "aria-describedby"], Nn = {
  inheritAttrs: !1
}, En = /* @__PURE__ */ x({
  ...Nn,
...
const jn = /* @__PURE__ */ Se(Hn, [["render", Rn]]), qn = {
  inheritAttrs: !1
}, Mn = /* @__PURE__ */ x({
  ...qn,
  ...
  setup(e, { emit: t }) {
    const a = e, l = $e(), n = ye(s(a, "id"), "form-check"), u = r(
      s(a, "indeterminate")
    ), f = r(s(a, "autofocus")), c = r(s(a, "plain")), v = r(s(a, "button")), h = r(s(a, "switch")), p = r(s(a, "disabled")), B = r(s(a, "inline")), C = r(s(a, "required")), V = r(s(a, "state")), A = U(null), b = U(!1), k = i(() => !Te(l.default)), y = i({
    ...
    return Be(() => {
      ...
      Xe(E("input", W({ id: o(n) }, z.$attrs, {
        ref_key: "input",
        ref: A,
        "onUpdate:modelValue": $[0] || ($[0] = (_) => tt(y) ? y.value = _ : null),
        class: o(F),
        type: "checkbox",
        disabled: o(p),
        required: !!e.name && !!o(C),
        ...
        value: e.value,
        indeterminate: o(u),
        onFocus: $[1] || ($[1] = (_) => b.value = !0),
        onBlur: $[2] || ($[2] = (_) => b.value = !1)
      }), null, 16, ts), [
        [Cl, o(y)]
      ]),
      o(k) || !o(c) ? (d(), m("label", {
  ...
  setup(e, { emit: t }) {
    ...
    r(s(a, "plain"));
    const h = r(s(a, "required")), p = r(s(a, "stacked")), B = r(s(a, "state")), C = r(s(a, "switches")), V = r(s(a, "validated")), A = i({
      get: () => a.modelValue,
      set: (H) => {
  ...
  setup(e, { attrs: t }) {
    const a = r(s(e, "disabled")), l = r(s(e, "labelSrOnly")), n = r(s(e, "state")), u = r(s(e, "tooltip")), f = r(s(e, "validated")), c = r(s(e, "floating")), v = null, h = ["xs", "sm", "md", "lg", "xl"], p = (L, z) => h.reduce(($, _) => {
      const D = Wt(_ === "xs" ? "" : _, `${z}Align`), q = L[D] || null;
      return q && (_ === "xs" ? $.push(`text-${q}`) : $.push(`text-${_}-${q}`)), $;
    }, []), B = (L, z) => h.reduce(($, _) => {
      const D = Wt(_ === "xs" ? "" : _, `${z}Cols`);
      let q = L[D];
      return q = q === "" ? !0 : q || !1, typeof q != "boolean" && q !== "auto" && (q = Ye(q, 0), q = q > 0 ? q : !1), q && (_ === "xs" ? $.cols = q : $[_ || (typeof q == "boolean" ? "col" : "cols")] = q), $;
    }, {}), C = U(), V = (L, z = null) => {
      if (Kl && e.labelFor) {
        const $ = $a(`#${Ul(e.labelFor)}`, C);
        if ($) {
          const _ = "aria-describedby", D = (L || "").split(ot), q = (z || "").split(ot), ee = (Nt($, _) || "").split(ot).filter((Y) => !q.includes(Y)).concat(D).filter((Y, G, ie) => ie.indexOf(Y) === G).filter((Y) => Y).join(" ").trim();
          ee ? so($, _, ee) : ro($, _);
        }
      }
...
const ys = /* @__PURE__ */ Se(ps, [["render", hs]]), Bs = ["id", "disabled", "required", "name", "form", "aria-label", "aria-labelledby", "value", "aria-required"], $s = ["for"], Qa = /* @__PURE__ */ x({
  __name: "BFormRadio",
  props: {
    ariaLabel: null,
    ariaLabelledBy: null,
  ...
  setup(e, { emit: t }) {
    const a = e, l = $e(), n = ye(s(a, "id"), "form-check"), u = r(s(a, "autofocus")), f = r(s(a, "plain")), c = r(s(a, "button")), v = r(s(a, "switch")), h = r(s(a, "disabled")), p = r(s(a, "inline")), B = r(s(a, "required")), C = r(s(a, "state")), V = U(null), A = U(!1), b = i({
    ...
    }), k = i(() => Array.isArray(a.modelValue) ? (a.modelValue || []).find((L) => L === a.value) : JSON.stringify(a.modelValue) === JSON.stringify(a.value)), y = i(() => !Te(l.default)), S = Le({
      plain: s(f, "value"),
      button: s(c, "value"),
      inline: s(p, "value"),
      switch: s(v, "value"),
  ...
  setup(e, { emit: t }) {
    ...
    const c = r(s(a, "buttons")), v = r(s(a, "disabled"));
    r(s(a, "plain"));
    const h = r(s(a, "required")), p = r(s(a, "stacked")), B = r(s(a, "state")), C = r(s(a, "validated")), V = i({
      get: () => a.modelValue,
      set: (S) => {
    ...
    return (S, H) => (d(), m("div", W(o(k), {
      ...
      (d(!0), m(Z, null, re(o(A), (T, F) => (d(), P(Qa, W({
        key: F,
        modelValue: o(V),
        "onUpdate:modelValue": H[0] || (H[0] = (L) => tt(V) ? V.value = L : null)
      }, T.props), {
        default: O(() => [
          T.html ? (d(), m("span", {
            key: 0,
...
}), Vs = ["id", "name", "form", "multiple", "size", "disabled", "required", "aria-required", "aria-invalid"], As = /* @__PURE__ */ x({
  __name: "BFormSelect",
  props: {
    ariaInvalid: { default: void 0 },
    autofocus: { default: !1 },
  ...
  setup(e, { emit: t }) {
    const a = e, l = $e(), n = ye(s(a, "id")), u = r(s(a, "disabled")), f = r(s(a, "noRemove")), c = r(s(a, "pill")), v = i(
      () => {
        var B, C, V;
        return (V = ((C = (B = l.default) == null ? void 0 : B.call(l)[0].children) == null ? void 0 : C.toString()) || a.title) != null ? V : "";
      }
    ...
    return (B, C) => (d(), P(X(e.tag), {
      ...
      default: O(() => [
        ...
        !o(u) && !o(f) ? (d(), P(Ke, {
          ...
          "aria-controls": e.id,
          onClick: C[0] || (C[0] = (V) => t("remove", o(v)))
  ...
  setup(e, { emit: t }) {
    const a = e, l = ye(), n = r(s(a, "addOnChange")), u = r(s(a, "autofocus")), f = r(s(a, "disabled")), c = r(s(a, "noAddOnEnter")), v = r(s(a, "noOuterFocus")), h = r(s(a, "noTagRemove")), p = r(s(a, "removeOnDelete")), B = r(s(a, "required")), C = r(s(a, "state")), V = r(s(a, "tagPills")), A = U(null), b = i(() => a.inputId || `${l.value}input__`), k = U(a.modelValue), y = U(""), S = U(!1), H = U(!1), T = U(""), F = U([]), L = U([]), z = U([]), $ = i(() => ({
      [`form-control-${a.size}`]: a.size !== void 0,
      disabled: f.value,
      focus: H.value,
      "is-invalid": C.value === !1,
      "is-valid": C.value === !0
    })), _ = i(() => k.value.includes(y.value)), D = i(
      () => y.value === "" ? !1 : !a.tagValidator(y.value)
    ), q = i(() => k.value.length === a.limit), ee = i(() => !D.value && !_.value), Y = i(() => ({
    ...
    const G = () => {
      ...
      F.value = a.tagValidator(te) && !_.value ? [te] : [], L.value = a.tagValidator(te) ? [] : [te], z.value = _.value ? [te] : [], t("tag-state", F.value, L.value, z.value);
    }, pe = (K) => {
      n.value && (he(K), _.value || me(y.value));
    }, ge = (K) => {
      ...
      var fe;
      if (K = (K || y.value).trim(), K === "" || _.value || !a.tagValidator(K) || a.limit && q.value)
        return;
    ...
    return Be(() => {
      ...
      g(K.$slots, "default", ve(Ce(o(Y))), () => [
        E("ul", {
          ...
          (d(!0), m(Z, null, re(k.value, (fe, de) => g(K.$slots, "tag", ve(W({ key: de }, { tag: fe, tagClass: e.tagClass, tagVariant: e.tagVariant, tagPills: o(V), removeTag: Fe })), () => [
            se(tl, {
              class: I(e.tagClass),
              tag: "li",
        ...
        E("div", Hs, [
          ...
          o(_) ? (d(), m("small", Rs, j(e.duplicateTagText) + ": " + j(y.value), 1)) : M("", !0),
...
const Xs = /* @__PURE__ */ Se(Gs, [["render", Ws]]), Ks = {
  key: 0,
  ...
  setup(e) {
    const t = e, a = da(), l = Ne(ll, null), n = r(s(t, "action")), u = r(s(t, "active")), f = r(s(t, "button")), c = r(s(t, "disabled")), v = i(() => !f.value && (!!t.href || !!t.to)), h = i(
      () => l != null && l.numbered ? "li" : f.value ? "button" : v.value ? _e : t.tag
    ), p = i(
  ...
  setup(e, { emit: t }) {
    const a = e, l = $e(), n = ye(s(a, "id"), "modal"), u = r(s(a, "busy")), f = r(s(a, "lazy")), c = r(s(a, "cancelDisabled")), v = r(s(a, "centered")), h = r(s(a, "hideBackdrop")), p = r(s(a, "hideFooter")), B = r(s(a, "hideHeader")), C = r(s(a, "hideHeaderClose")), V = r(s(a, "modelValue")), A = r(s(a, "noCloseOnBackdrop")), b = r(s(a, "noCloseOnEsc")), k = r(s(a, "noFade")), y = r(s(a, "noFocus")), S = r(s(a, "okDisabled")), H = r(s(a, "okOnly")), T = r(s(a, "scrollable")), F = r(s(a, "titleSrOnly")), L = r(s(a, "static")), z = U(!1), $ = U(null), _ = U(!1), D = i(() => [
      a.modalClass,
      {
        fade: !k.value,
        show: z.value
      }
    ]), q = i(() => !Te(l["header-close"])), ee = i(() => [
      a.dialogClass,
      {
      ...
      !b.value && V.value && de.key === "Escape" && pe();
    }, me = () => t("show"), Fe = () => {
      z.value = !0, t("shown"), f.value === !0 && (_.value = !0);
    }, K = () => t("hide"), te = () => {
      z.value = !1;
    }, fe = () => {
      t("hidden"), f.value === !0 && (_.value = !1);
    };
    return ne(
      () => V.value,
      (de) => {
        ...
        default: O(() => [
          Xe(E("div", W({
            ...
            E("div", {
              ...
              !o(f) || o(f) && _.value || o(f) && o(V) === !0 ? (d(), m("div", {
                key: 0,
                  ...
                  g(de.$slots, "header", {}, () => [
                    ...
                    o(C) ? M("", !0) : (d(), m(Z, { key: 0 }, [
                      o(q) ? (d(), m("button", {
                        ...
                        onClick: we[0] || (we[0] = (qe) => pe())
                      }, [
                        g(de.$slots, "header-close", {}, void 0, !0)
                      ])) : (d(), P(Ke, {
                        key: 1,
                        "aria-label": e.headerCloseLabel,
                        "data-bs-dismiss": "modal",
                        white: e.headerCloseWhite,
                        onClick: we[1] || (we[1] = (qe) => pe())
                  ...
                  g(de.$slots, "footer", {}, () => [
                    g(de.$slots, "cancel", {}, () => [
                      o(H) ? M("", !0) : (d(), P(et, {
                        ...
                        onClick: we[2] || (we[2] = (qe) => (pe(), t("cancel")))
                      }, {
                        default: O(() => [
                          J(j(e.cancelTitle), 1)
                        ]),
...
const dr = /* @__PURE__ */ Se(ur, [["__scopeId", "data-v-12b3ec86"]]), cr = /* @__PURE__ */ x({
  __name: "BNav",
  props: {
    align: null,
...
const pr = /* @__PURE__ */ Se(vr, [["render", br]]), gr = { class: "nav-item dropdown" }, hr = /* @__PURE__ */ x({
...
}), yr = { class: "navbar-text" }, Br = /* @__PURE__ */ x({
  __name: "BNavText",
  props: {
    text: null
  },
  setup(e) {
    return (t, a) => (d(), m("li", yr, [
      g(t.$slots, "default", {}, () => [
        J(j(e.text), 1)
      ])
    ]));
...
const Sr = /* @__PURE__ */ Se(kr, [["render", Cr]]), wr = /* @__PURE__ */ x({
  __name: "BNavbarNav",
  props: {
    align: null,
    fill: { default: !1 },
...
}), Tr = /* @__PURE__ */ E("span", { class: "navbar-toggler-icon" }, null, -1), _r = /* @__PURE__ */ x({
...
}), Vr = ["data-bs-backdrop", "data-bs-scroll"], Ar = {
  key: 0,
  class: "offcanvas-header"
}, xr = {
  id: "offcanvasLabel",
  class: "offcanvas-title"
}, Ir = { class: "offcanvas-body" }, Fr = { key: 1 }, Pr = /* @__PURE__ */ x({
  __name: "BOffcanvas",
  props: {
    dismissLabel: { default: "Close" },
    modelValue: { default: !1 },
  ...
  emits: ["update:modelValue", "show", "shown", "hide", "hidden"],
  setup(e, { emit: t }) {
    const a = e, l = r(s(a, "modelValue")), n = r(s(a, "bodyScrolling")), u = r(s(a, "backdrop")), f = r(s(a, "noHeaderClose")), c = r(s(a, "noHeader")), v = $e(), h = U(), p = U(), B = i(() => !Te(v.footer)), C = i(() => [`offcanvas-${a.placement}`]), V = () => {
      t("show"), t("update:modelValue", !0);
    }, A = () => {
      t("hide"), t("update:modelValue", !1);
    };
...
}), zr = 5, ol = 20, nl = 0, Pe = 3, Lr = "ellipsis-text", Nr = "first-text", Er = "last-text", Hr = "next-text", Dr = "page", Rr = "prev-text", la = (e) => Math.max(Ue(e) || ol, 1), oa = (e) => Math.max(Ue(e) || nl, 0), jr = (e, t) => {
  const a = Ue(e) || 1;
  ...
  setup(e, { emit: t, slots: a }) {
    const l = r(s(e, "disabled")), n = r(s(e, "firstNumber")), u = r(s(e, "hideEllipsis")), f = r(s(e, "hideGotoEndButtons")), c = r(s(e, "lastNumber")), v = r(s(e, "pills")), h = El(s(e, "align")), p = i(
      ...
      let T;
      return p.value - e.modelValue + 2 < e.limit && e.limit > Pe ? T = p.value - V.value + 1 : T = e.modelValue - Math.floor(V.value / 2), T < 1 ? T = 1 : T > p.value - V.value && (T = p.value - V.value + 1), e.limit <= Pe && c.value && p.value === T + V.value - 1 && (T = Math.max(T - 1, 1)), T;
    }), C = i(() => {
    ...
    const H = i(() => {
      const T = [];
      for (let F = 0; F < V.value; F++)
        T.push({ number: B.value + F, classes: null });
      return T;
    });
    return () => {
      const T = [], F = H.value.map((G) => G.number), L = (G) => G === e.modelValue, z = e.modelValue < 1, $ = e.align === "fill", _ = (G, ie, ce, Q, he, pe) => {
  ...
  setup(e) {
    ...
    return (C, V) => e.responsive ? (d(), m("div", {
      key: 1,
      class: I(o(B))
    }, [
      E("table", {
    ...
    return (B, C) => (d(), P(yt, null, {
      default: O(() => [
        o(h) ? M("", !0) : g(B.$slots, "thead", { key: 0 }, () => [
          E("thead", null, [
            E("tr", null, [
              (d(!0), m(Z, null, re(o(n), (V, A) => (d(), m("th", { key: A }, [
        ...
        g(B.$slots, "default", {}, () => [
          E("tbody", null, [
            (d(!0), m(Z, null, re(o(l), (V, A) => (d(), m("tr", { key: A }, [
        ...
        o(p) ? g(B.$slots, "tfoot", { key: 1 }, () => [
          E("tfoot", null, [
            E("tr", null, [
              (d(!0), m(Z, null, re(o(u), (V, A) => (d(), m("th", { key: A }, [
  ...
  setup(e, { emit: t, slots: a }) {
    ...
    const l = r(s(e, "show")), n = r(s(e, "html")), u = r(s(e, "sanitize")), f = U(), c = U(), v = U(), h = U(), p = U(), B = i(() => ({
      ...
      c.value = V(C(b)), c.value && (v.value = new wt(c.value, {
...
}), Xr = ["id"], Kr = { ref: "titleRef" }, Jr = { ref: "contentRef" };
function Yr(e, t, a, l, n, u) {
  return d(), m("div", {
    id: e.id,
    ref: "element",
...
const Zr = /* @__PURE__ */ Se(Wr, [["render", Yr]]), Qr = ["aria-valuenow", "aria-valuemax"], rl = /* @__PURE__ */ x({
  __name: "BProgressBar",
  props: {
    animated: { default: !1 },
    label: null,
...
}), na = bt("cols", [""], { type: [String, Number], default: null }), ti = x({
  name: "BRow",
  props: {
    tag: { type: String, default: "div" },
...
const li = /* @__PURE__ */ Se(ti, [["render", ai]]), rt = /* @__PURE__ */ x({
  __name: "BSkeleton",
  props: {
    height: null,
    width: null,
...
}), ni = { key: 0 }, si = { key: 1 }, ri = /* @__PURE__ */ x({
  ...
  if (!e || !e.target)
    return !1;
  const t = e.target;
  if ("disabled" in t && t.disabled || ui.indexOf(t.tagName) !== -1)
    return !1;
  ...
  const e = (v, h) => {
    ...
    return h.sort((V, A) => {
      if (B !== void 0)
        return B(V, A, p.key, p.desc);
      const b = (S) => typeof S == "object" ? JSON.stringify(S) : S;
      return b(V[C]) > b(A[C]) ? p.desc ? -1 : 1 : b(A[C]) > b(V[C]) ? p.desc ? 1 : -1 : 0;
    });
  }, u = (v, h, p) => v.filter(
    (B) => Object.entries(B).filter((C) => {
      const [V, A] = C;
      return !A || V[0] === "_" || p.length > 0 && !p.includes(V) ? !1 : (typeof A == "object" ? JSON.stringify(Object.values(A)) : typeof A == "string" ? A : A.toString()).toLowerCase().includes(h.toLowerCase());
    }).length > 0
  );
  return {
    normaliseFields: e,
...
}, fi = ["title", "abbr", "onClick"], vi = { class: "d-inline-flex flex-nowrap align-items-center gap-1" }, mi = { key: 1 }, bi = ["onClick", "onDblclick", "onMouseenter", "onMouseleave"], pi = {
  key: 0,
  class: "b-table-stacked-label"
}, gi = ["colspan"], hi = ["colspan"], yi = { class: "d-flex align-items-center justify-content-center gap-2" }, Bi = /* @__PURE__ */ E("strong", null, "Loading...", -1), $i = {
  key: 1,
  class: "b-table-empty-slot"
}, ki = ["colspan"], Ci = { key: 0 }, Si = ["title", "abbr", "onClick"], wi = { key: 1 }, Ti = { key: 2 }, _i = { key: 3 }, Vi = /* @__PURE__ */ x({
  __name: "BTable",
  props: {
    align: null,
    caption: null,
  ...
  setup(e, { expose: t, emit: a }) {
    const l = e, n = $e(), u = ci(), f = r(s(l, "footClone")), c = r(s(l, "sortDesc")), v = r(s(l, "sortInternal")), h = r(s(l, "selectable")), p = r(s(l, "stickySelect")), B = r(s(l, "labelStacked")), C = r(s(l, "busy")), V = r(s(l, "showEmpty")), A = r(s(l, "noProviderPaging")), b = r(s(l, "noProviderSorting")), k = r(s(l, "noProviderFiltering")), y = U(C.value);
    ...
    const S = U(/* @__PURE__ */ new Set([])), H = i(() => S.value.size > 0), T = i(() => ({
    ...
    ), $ = i(() => l.filter !== void 0 && l.filter !== ""), _ = i(() => l.provider !== void 0), D = i(
      ...
      const w = _.value ? u.internalItems.value : ee.value ? u.mapItems(l.fields, l.items, l, {
        isSortable: q,
        isFilterableTable: $,
        sortDescBoolean: c
      }) : l.items;
    ...
    return ne(
      () => l.filter,
      (w, R) => {
        w === R || _.value || w || Tt(l.items).then((ae) => a("filtered", ae));
      }
    ), ne(
      () => y.value,
      ...
      default: O(() => {
        ...
        return [
            ...
            (d(!0), m(Z, null, re(o(Y), (N, ke) => (d(), m(Z, { key: ke }, [
              E("tr", {
                ...
                (d(!0), m(Z, null, re(o(L), (oe) => (d(), m("td", W({
                  ...
                  e.stacked && o(B) ? (d(), m("label", pi, j(G(oe)), 1)) : M("", !0),
          ...
          ])) : w.$slots["custom-foot"] ? (d(), m("tfoot", wi, [
          ...
          w.$slots["table-caption"] ? (d(), m("caption", Ti, [
            g(w.$slots, "table-caption")
          ])) : e.caption ? (d(), m("caption", _i, j(e.caption), 1)) : M("", !0)
        ];
      }),
      _: 3
    }, 16));
...
}), xi = ["scope", "colspan", "rowspan", "data-label"], Ii = { key: 0 }, Fi = /* @__PURE__ */ x({
  __name: "BTd",
  props: {
    colspan: null,
    rowspan: null,
...
}), Oi = ["scope", "colspan", "rowspan", "data-label"], zi = { key: 0 }, Li = /* @__PURE__ */ x({
  __name: "BTh",
  props: {
    colspan: null,
    rowspan: null,
  ...
  setup(e) {
    ...
    return (u, f) => (d(), m("th", {
      ...
      e.stackedHeading !== void 0 ? (d(), m("div", zi, [
        g(u.$slots, "default")
      ])) : g(u.$slots, "default", { key: 1 })
    ], 10, Oi));
  }
...
}), Hi = ["id", "data-bs-target", "aria-controls", "aria-selected", "onClick"], ul = Symbol(), Di = /* @__PURE__ */ x({
  __name: "BTabs",
  props: {
  ...
  setup(e, { emit: t }) {
    const a = e, l = r(s(a, "card")), n = r(s(a, "end")), u = r(s(a, "fill")), f = r(s(a, "justified")), c = r(s(a, "lazy")), v = r(s(a, "noFade")), h = r(s(a, "noNavStyle")), p = r(s(a, "pills")), B = r(s(a, "small")), C = r(s(a, "vertical")), V = $e(), A = U(a.modelValue), b = U(""), k = i({
      get: () => A.value,
      set: ($) => {
      ...
      let $ = [];
      return V.default && ($ = z(V).map((_, D) => {
        _.props || (_.props = {});
        const q = _.props["button-id"] || ze("tab"), ee = _.props.id || ze(), Y = k.value > -1 ? D === k.value : _.props.active === "", G = _.props["title-item-class"], ie = _.props["title-link-attributes"];
        return {
          buttonId: q,
          contentId: ee,
          active: Y,
      ...
      if ($ !== void 0 && $ > -1 && $ < y.value.length && !y.value[$].disabled && (k.value < 0 || y.value[$].buttonId !== b.value)) {
        ...
        t("activate-tab", $, k.value, D), D.defaultPrevented || (k.value = $, _ = !0);
      }
      return !_ && a.modelValue !== k.value && t("update:modelValue", k.value), _;
    }, L = ($, _) => {
      var D;
      F(_), _ >= 0 && !y.value[_].disabled && ((D = y.value[_]) == null ? void 0 : D.onClick) && typeof y.value[_].onClick == "function" && y.value[_].onClick($);
    }, z = ($) => !$ || !$.default ? [] : $.default().reduce((_, D) => (typeof D.type == "symbol" ? _ = _.concat(D.children) : _.push(D), _), []).filter((_) => {
      var D;
      return ((D = _.type) == null ? void 0 : D.__name) === "BTab";
    });
    return F(A.value), ne(
      () => a.modelValue,
      ($, _) => {
        if ($ === _)
          return;
        if ($ = Math.max($, -1), _ = Math.max(_, -1), y.value.length <= 0) {
          k.value = -1;
          return;
        }
        const D = $ > _;
      ...
      () => y.value,
      () => {
        let $ = y.value.map((_) => _.active && !_.disabled).lastIndexOf(!0);
        $ < 0 && (k.value >= y.value.length ? $ = y.value.map((_) => !_.disabled).lastIndexOf(!0) : y.value[k.value] && !y.value[k.value].disabled && ($ = k.value)), $ < 0 && ($ = y.value.map((_) => !_.disabled).indexOf(!0)), y.value.forEach((_, D) => _.active = D === $), F($);
      }
    ), Be(() => {
      if (k.value < 0 && y.value.length > 0 && !y.value.some(($) => $.active)) {
        const $ = y.value.map((_) => !_.disabled).indexOf(!0);
        F($ >= 0 ? $ : -1);
      }
    }), We(ul, {
      lazy: c.value,
  ...
  setup(e, { emit: t, slots: a }) {
    ...
    const L = () => {
      k(), n.value && (V = setTimeout(S, b || y.value), A = Date.now(), b = 0);
    }, z = () => {
...
function Ui(e, t = Pt) {
  ...
  const l = { id: Symbol("toastInstance") }, n = { ...Mi, ...l, ...e }, u = a.getOrCreateViewModel(n);
  return new ia(u);
}
const Wi = {
  install: (e, t = {}) => {
    var a, l, n, u;
    e.provide(cl, (l = (a = t == null ? void 0 : t.BToast) == null ? void 0 : a.injectkey) != null ? l : Pt), e.provide((u = (n = t == null ? void 0 : t.BToast) == null ? void 0 : n.injectkey) != null ? u : Pt, new qi());
  }
}, Xi = {
  BAccordion: bo,
  BAccordionItem: Fo,
  ...
  BPlaceholderCard: Mr,
  BPlaceholderTable: Gr,
  BPlaceholderWrapper: Ur,
  BPopover: Zr,
  BProgress: ei,
  BProgressBar: rl,
  BRow: li,
...
const Zi = {
  install(e, t = {}) {
    Object.entries(Xi).forEach(([a, l]) => {
      e.component(a, l);
    }), Object.entries(_o).forEach(([a, l]) => {
      e.directive(a, l);
    }), fo(e);
  }
};
export {
  ...
  Mr as BPlaceholderCard,
  Gr as BPlaceholderTable,
  Ur as BPlaceholderWrapper,
  Zr as BPopover,
  ei as BProgress,
  rl as BProgressBar,
  li as BRow,
